...
def load_disease_network(disease_sim_file="../Data/MeSHID_Net.txt"):
...
def main(embedding_size=128, epochs=50, disease_sim_file="../Data/MeSHID_Net.txt"):
    ...
    disease_output_file = f"../Results/Embeddings/{disease_base_name}_{emb_method}_d_{embedding_size}_e_{epochs}.csv" 
...
if __name__ == "__main__":
    disease_sim_file = "../Data/MeSHID_Net.txt"
